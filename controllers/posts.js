...
export const getPosts =  async(req,res) => {//Ruta get para esta direccion
    try {
...
export const updatePost = async(req,res) => {
    const { id: _id } = req.params;//renombrar en destructuracion
    const post = req.body
...
export const likePost = async(req,res) => {
    ...
    //check if user already likes that post
